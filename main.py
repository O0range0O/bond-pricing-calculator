...
lblT.place(x=10,y=0)
lblk.place(x=10,y=25)
lblt.place(x=12,y=50)
lblPr.place(x=89,y=0)
edtT = Spinbox(root, from_=0, to=100, increment=1, width=5, textvariable=var_T)
edtk = Spinbox(root, from_=0, to=10, increment=1, width=5, textvariable=var_k)
edtt = Spinbox(root, from_=0, to=10, increment=1, width=5, textvariable=var_t)
edtPr = Spinbox(root, from_=0, to=100, increment=0.5, width=5, textvariable=var_proc)
edtT.place(x=32,y=0)
edtk.place(x=32,y=25)
edtt.place(x=32,y=50)
edtPr.place(x=118,y=0)

lblPrice = Label(root, text='Цена ZCB₁₀: ')
lblPriceResult = Label(root, text='№№№')
lblPrice.place(x=10,y=100)
lblPriceResult.place(x=78,y=100)

lblE = Label(root, text='E = ')
edtE = Spinbox(root, from_=0, to=100, increment=0.5, width=5, textvariable=var_E)
lblE.place(x=93,y=25)
edtE.place(x=118,y=25)

lbl6 = Label(root, text='Форвард: ')
lbl6.place(x=10,y=125)
lbl6Result = Label(root, text='№№№')
lbl6Result.place(x=77,y=125)

lbl7 = Label(root, text='Фьючерс: ')
lbl7.place(x=10,y=150)
lbl7Result = Label(root, text='№№№')
lbl7Result.place(x=77,y=150)


lbl8 = Label(root, text='Опцион Call: ')
lbl8.place(x=10,y=175)
lbl8Result = Label(root, text='№№№')
lbl8Result.place(x=94,y=175)
